...
class PostOfficeSettlement implements PostOfficeSettlementInterface
{
  ...
  public function toArray(?LanguagesEnumInterface $language = null): array
  {
    ...
    $data = [
      ...
      'isCash' => $this->isCash(),
      'isDhl' => $this->isDhl(),
      'isSmartbox' => $this->isSmartbox(),
      'isUrgentPostalTransfers' => $this->isUrgentPostalTransfers(),
      'isFlagman' => $this->isFlagman(),
      'hasPostTerminal' => $this->hasPostTerminal(),
      'isAutomated' => $this->isAutomated(),
      'isSecurity' => $this->isSecurity(),
      'lockCode' => $this->getlockCode(),
      'phone' => $this->getphone(),
      'isVpz' => $this->isVpz(),
      'merezaNumber' => $this->getmerezaNumber(),
      'techIndex' => $this->gettechIndex(),
    ];
